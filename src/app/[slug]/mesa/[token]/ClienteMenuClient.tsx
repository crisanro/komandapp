...
import ResenaForm from "@/components/cliente/ResenaForm";
import PedirCuentaFlow from "@/components/cliente/PedirCuentaFlow";
...
export default function ClienteMenuClient({
  sesion, menu, restaurantId, token, tieneFactura, tieneFidelidad,
}: {
  sesion:         Sesion;
  menu:           Categoria[];
  restaurantId:   string;
          ...
          <div className="space-y-2">
            <PedirCuentaFlow
              ...
              onComplete={(total) => {
                ...
                setTimeout(() => setMostrarResena(true), 2000);
              }}
            />
          </div>
        )}
        ...
        {mostrarResena && (
          ...
          >
            ...
            >
              ...
              <ResenaForm sesionToken={token} color={color} />
            </div>
          </div>
        )}
