...
type Restaurant = { nombre: string; notaCuenta: string | null; propinaModo: string | null; porcentajePropina: number | null; moneda: string | null };

export default function CajaClient({
  sesionesIniciales, restaurant, restaurantId, nombre,
